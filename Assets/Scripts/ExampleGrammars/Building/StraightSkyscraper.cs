...
namespace Demo
{
    public class StraightSkyscraper : Shape
    {
        ...
        private void GenerateStock()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                if (i == doorWallIndex)
                {
                    newRow = CreateSymbol<StraightRow>("wallWithDoor", localPosition, Quaternion.Euler(0, i * 90, 0));
                ...
                {
                    newRow = CreateSymbol<StraightRow>("balcony", localPosition, Quaternion.Euler(0, i * 90, 0));
                    newRow.Initialize(i % 2 == 1 ? Width : Depth, new GameObject[] { balconyPrefab });
                }
                else
                {
                    newRow = CreateSymbol<StraightRow>("wall", localPosition, Quaternion.Euler(0, i * 90, 0));
            ...
            {
                StraightStock nextStock = CreateSymbol<StraightStock>("stock", new Vector3(0, 1, 0));
