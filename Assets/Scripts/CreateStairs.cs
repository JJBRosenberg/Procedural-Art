	...
	public class CreateStairs : MonoBehaviour {
		...
		void CreateShape() {
			...
			for (int i = 0; i < numberOfSteps; i++) {
				...
				// top back:
				int v5 = builder.AddVertex (offset + new Vector3 (width / 2, height, depth), new Vector2 (0, 1));	
				int v6 = builder.AddVertex (offset + new Vector3 (-width / 2, height, depth), new Vector2 (1, 1));
