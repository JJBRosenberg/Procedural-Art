...
/**
 * This defines a custom property drawer for the regexattribute.
 * This difference with a custom inspector is that this only defines an inspector for a single custom field
 * and not for the whole component.
 */
