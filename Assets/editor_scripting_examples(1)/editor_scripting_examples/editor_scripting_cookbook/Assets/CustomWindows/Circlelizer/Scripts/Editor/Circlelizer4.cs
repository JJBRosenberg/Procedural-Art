...
/**
 * A Circlelizer version with saving.
 * 
 * The only changes are in OnEnable/OnDisable and the definitions of the fields
 */
public class Circlelizer4 : EditorWindow
{
	[MenuItem("Custom menu/Cirlelizer yeah! (4)")]
	private static void init()
	{
		Circlelizer4 window = GetWindow<Circlelizer4>("Circlelizer yeah!");
	...
	[SerializeField] private Quaternion _facing = Quaternion.identity;
	[SerializeField] private float _radius = 5;
	[SerializeField] private bool _spiral = false;
	[SerializeField] private float _rotations = 1;
	[SerializeField] private bool _lookAtCenter = false;
